...
abstract class Generator
{
     ...
     */
    public function type(string $entityType)
    {
    ...
    {
        $folder = $this->config->get('encore.workshop.config.custom-stubs-folder');
     ...
     */
    protected function getContentForStub(string $stub, string $class)
    {
