...
class ThemeScaffoldTest extends BaseTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->scaffold = $this->app['encore.theme.scaffold'];
    ...
    public function it_throws_exception_if_no_name_provided()
    {
        ...
        $this->scaffold->setName('')->forType('frontend')->setVendor('encorecms')->generate();
    }
    ...
    public function it_throws_exception_if_no_type_provided()
    {
        ...
        $this->scaffold->setName($this->testThemeName)->forType('')->setVendor('encorecms')->generate();
    }
