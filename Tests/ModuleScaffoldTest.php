...
class ModuleScaffoldTest extends BaseTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->scaffold = $this->app['encore.module.scaffold'];
    }
    ...
    public function it_should_use_correct_vendor_name_in_composer_json()
    {
        ...
        $this->assertEquals('encorecms/testingthetestmodule', $composerJson->name);
    }

    /** @test */
    public function it_should_change_the_type_to_encore_module()
    {
        $this->scaffoldModuleWithEloquent();

        $composerJson = $this->getComposerFile();

        $this->assertEquals('encore-module', $composerJson->type);
    }
    ...
    {
        config()->set('encore.workshop.config.custom-stubs-folder', __DIR__ . '/stubs');
