...
class WorkshopServiceProvider extends ServiceProvider
{
    ...
    private function registerCommands()
    {
        ...
        $this->commands([
            'command.encore.module.scaffold',
            'command.encore.module.update',
            'command.encore.theme.scaffold',
    ...
    {
        $this->app->singleton('encore.module.scaffold', function ($app) {
        ...
        $this->app->singleton('command.encore.module.scaffold', function ($app) {
            return new ModuleScaffoldCommand($app['encore.module.scaffold']);
        });
    }
    ...
    {
        $this->app->singleton('command.encore.module.update', function ($app) {
    ...
    {
        $this->app->singleton('encore.theme.scaffold', function ($app) {
            return new ThemeScaffold(new ThemeGeneratorFactory(), $app['files']);
        });

        $this->app->singleton('command.encore.theme.scaffold', function ($app) {
            return new ThemeScaffoldCommand($app['encore.theme.scaffold']);
        });
    }
